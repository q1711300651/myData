...
public class AESUTIL {
    //初始向量
    public static final String VIPARA = "Iccibtwicy_xykey";   //AES 为16bytes. DES 为8bytes

    //编码方式
    public static final String bm = "UTF-8";

    //私钥
    private static final String ASE_KEY="Iccibtwicy_xykey";   //AES固定格式为128/192/256 bits.即：16/24/32bytes。DES固定格式为128bits，即8bytes。
